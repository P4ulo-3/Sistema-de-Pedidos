        ...
        >
          ...
          <div className="px-2 py-4 border-t border-surface-700">
            <button
              ...
              className="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-red-600/15 hover:text-red-400 transition-colors duration-150"
            >
